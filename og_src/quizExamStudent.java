...
public class quizExamStudent extends javax.swing.JFrame {
    ...
    {   
        ...
        //answer =  "Select answer from questionid where id=questions"
        String answer="";
           try{
               
               
                                Class.forName("com.mysql.cj.jdbc.Driver");// Driver to Connect mySQL. Jo database use karte uska alag driver hota jaise     oracle k sql ka alag hoga.
				
				//Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/adi","root","happy");// 
				
				
                                Connection con=ConnectionProvider.getCon();
				Statement stmt=con.createStatement();
				
				ResultSet rs=stmt.executeQuery("Select answer from question where id='"+questionId+"'");
            ...
            if(rs.next())
            {
                ...
                answer =String.valueOf(rs.getString(1));
                System.out.println(answer);
                   ...
                   {
                       if(!studentAnswer.equals("")&&!answer.equals(""))
                       {
                          System.out.println(answer);
                          System.out.println(studentAnswer);
                        marks=marks+1;
    ...
    public void question()
    {
       // this.setVisible(false);
        //quizExamStudent q=new quizExamStudent();
         try
        {
            Connection con=ConnectionProvider.getCon();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 130, 370, 640));

        jLabel20.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        jLabel20.setText("QuestionDemo?");
        getContentPane().add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(403, 162, -1, -1));
        ...
        getContentPane().add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 280, -1, -1));
        ...
        getContentPane().add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 360, -1, -1));
        ...
        getContentPane().add(jRadioButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 440, -1, -1));
        ...
        getContentPane().add(jRadioButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 530, -1, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 630, -1, -1));
        ...
        getContentPane().add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1420, -1));
